// this is a derivitive of https://github.com/moby/moby/blob/master/pkg/namesgenerator/names-generator.go
package main
...
func main() {
	name := fmt.Sprintf("%s %s %s", left[rand.Intn(len(left))], center[rand.Intn(len(right))], right[rand.Intn(len(center))])
	fmt.Println(name)
}
